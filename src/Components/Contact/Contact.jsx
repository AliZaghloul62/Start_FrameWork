...
export default function Contact() {
  return (
    <section
      id="contact"
      className="contact-section min-vh-100 d-flex justify-content-center align-items-center"
    >
      <div className="container-fluid">
        ...
        <div className="w-50 mx-auto">
          ...
          <button className="px-2 py-1 text-white rounded-2">Send Message</button>
        </div>
      </div>
    </section>
  );
