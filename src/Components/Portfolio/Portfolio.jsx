...
export default function Portfolio() {
  function previewImg(source) {
    document.querySelector("#img-preview").setAttribute("src", source);
  ...
  return (
    <section
      id="portfolio"
      className="min-vh-100 d-flex justify-content-center align-items-center mt-3 mb-5 bg-white"
    >
